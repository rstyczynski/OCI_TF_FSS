...
output "mount_target_summary" {
  ...
  value = {
    ...
    availability_domain = module.fss_stack.mount_targets["primary"].availability_domain
    subnet_ocid         = module.fss_stack.mount_targets["primary"].subnet_ocid
