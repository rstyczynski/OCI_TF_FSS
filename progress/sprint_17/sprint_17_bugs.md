...
- **Verification**: BUG-13 A1 smoke gate — `progress/sprint_17/test_run_A1_smoke_bug13_20260503_083329.log`. A3 integration NOT RUN (requires live OCI) per RUP_patch.md P2.
