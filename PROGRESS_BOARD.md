...
| Sprint 5 | implemented | PBI-007. FSS module - expose kms_key_id argument at mandatory variables | implemented |
| Sprint 5 | implemented | PBI-008. FSS module - expose rest of all available arguments at with default values | implemented |
| Sprint 5 | implemented | PBI-009. Create higher level module that accepts map of arguments to support multiple FSS with all mount points and exports | implemented |
